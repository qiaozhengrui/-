        ...
        <div class="InfoWrap">
            ...
            <div class="priceArea">
              ...
              <div class="priceArea2">
                ...
                <div class="fixWidth">
                  ...
                  <em class="t-gray">满999.00另减20.00元，或满1999.00另减30.00元，或满2999.00另减40.00元，即可在购物车换购热销商品</em>
                </div>
              </div>
            </div>
            <div class="support">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 路由跳转之前，需发请求，把购买的商品信息通过请求的形式通知服务器，服务器进行相应的存储 -->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      skuImageList() {
        //服务器数据没回来之前，skuInfo是个空对象下
        return this.skuInfo.skuImageList || []
      }
    },
    methods: {
      //商品的售卖属性值切换高亮
      changeActive(saleAttrName, arr) {
        //遍历全部的商品售卖属性值的isChecked为0，则无高亮
        arr.forEach(it => {
          it.isChecked = 0
        })
        //此时点击的售卖属性值则高亮
        saleAttrName.isChecked = 1
      },
      //表单元素修改商品个数
      changeskuNum(e) {
        //用户输入进来的文本*1
